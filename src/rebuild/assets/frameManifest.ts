...
export const REBUILD_ENEMIES: readonly RebuildSprite[] = [
  ...
  { id: "runner", width: 64, height: 64, scale: 3, anchorX: 32, anchorY: 63, animations: { walk: { frames: authoredFramePaths("runner", "walk", 6), frameDurationMs: 80, loop: true }, windup: { frames: authoredFramePaths("runner", "windup", 3), frameDurationMs: 80, loop: true }, attack: { frames: authoredFramePaths("runner", "attack", 4), frameDurationMs: 55, loop: false }, hurt: { frames: authoredFramePaths("runner", "hurt", 2), frameDurationMs: 80, loop: false }, recover: { frames: authoredFramePaths("runner", "recover", 2), frameDurationMs: 90, loop: false }, dead: { frames: authoredFramePaths("runner", "dead", 3), frameDurationMs: 80, loop: false } } },
